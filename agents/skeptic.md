...
Input: a spec, design overview, or checkpoint document. Your job is generative: attack the design and surface the holes its author did not consider. This is not refutation of stated claims - it is the hunt for what is NOT stated.
