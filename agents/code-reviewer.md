...
tools: Agent, Bash, Glob, Grep, Read, WebFetch, WebSearch, mcp__context7__resolve-library-id, mcp__context7__query-docs, Skill, TaskList, SendMessage, ToolSearch, TaskGet, ListMcpResourcesTool, ReadMcpResourceTool
model: opus[1m]
color: purple
---
