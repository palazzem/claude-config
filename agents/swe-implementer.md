...
tools: Agent, Bash, Read, Edit, Write, Glob, Grep, NotebookEdit, SendMessage, Skill, WebFetch, WebSearch, mcp__context7__resolve-library-id, mcp__context7__query-docs
model: opus[1m]
---
