...
| `implement` | Manual entry point of the delivery chain: worktree, persistent builder, draft PR, review loop via `review-panel`, open flip, one message, monitor watch. |
